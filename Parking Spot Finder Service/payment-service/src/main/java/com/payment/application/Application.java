...
public class Application {
    ...
    public JaegerTracer  initTracer() {
        SamplerConfiguration samplerConfig = SamplerConfiguration.fromEnv().withType("probabilistic").withParam(0.1);
        ReporterConfiguration reporterConfig = ReporterConfiguration.fromEnv().withLogSpans(true);
        Configuration config = new Configuration("Payment-Serivce").withSampler(samplerConfig).withReporter(reporterConfig);
