package com.park.spot.application;
...
//        SenderConfiguration sender = SenderConfiguration.fromEnv().withEndpoint("http://localhost:8081/traces");
//        reporterConfig.withSender(sender);
        Configuration config = new Configuration("Root-Service").withSampler(samplerConfig).withReporter(reporterConfig);
